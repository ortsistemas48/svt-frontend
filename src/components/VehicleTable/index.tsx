          ...
          <div className="space-y-3">
            ...
            {remaining > 0 && (
              <details className="group">
                <summary className="cursor-pointer flex items-center justify-center gap-2 py-3 px-4 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-[14px] text-sm font-medium text-gray-700 transition-colors duration-200 list-none">
